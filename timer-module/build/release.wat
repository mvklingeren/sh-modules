(module
 ...
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 36148))
 (memory $0 1)
 ...
 (data $23.1 (i32.const 3272) "\02\00\00\00\0c\00\00\00S\00T\00A\00R\00T\00:")
 (data $24 (i32.const 3292) "\1c")
 (data $24.1 (i32.const 3304) "\02\00\00\00\n\00\00\00S\00T\00O\00P\00:")
 (data $25 (i32.const 3324) "\1c")
 (data $25.1 (i32.const 3336) "\02\00\00\00\0c\00\00\00R\00E\00S\00E\00T\00:")
 (data $26 (i32.const 3360) "\04\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$138
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 3024
     local.set $0
     br $__inlined_func$~lib/string/String#concat$138
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
