(module
 ...
 (data $0.1 (i32.const 1048) "\02\00\00\00\0c\00\00\00S\00T\00A\00R\00T\00:")
 ...
 (data $21 (i32.const 3148) "\1c")
 (data $21.1 (i32.const 3160) "\02\00\00\00\n\00\00\00T\00I\00C\00K\00:")
 (data $22 (i32.const 3180) "\1c")
 (data $22.1 (i32.const 3192) "\02\00\00\00\n\00\00\00S\00T\00O\00P\00:")
 (data $23 (i32.const 3212) "\1c")
 (data $23.1 (i32.const 3224) "\02\00\00\00\0c\00\00\00R\00E\00S\00E\00T\00:")
 (data $24 (i32.const 3248) "\04\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/string/String.__concat (param $0 i32) (param $1 i32) (result i32)
  ...
  block $folding-inner0
   ...
   local.get $1
   i32.store
   block $__inlined_func$~lib/string/String#concat$134
    local.get $1
    i32.const 20
    i32.sub
    i32.load offset=16
    ...
    if
     ...
     i32.const 3024
     local.set $0
     br $__inlined_func$~lib/string/String#concat$134
    end
    global.get $~lib/memory/__stack_pointer
    local.get $0
    i32.const 2
